...
public class Main {
    ...
    public static void main (String args[]) throws IOException {
        ...
        Boolean propriedadesSorteadas = false;
        ...
        try {
            for (int i = 0; i < quantidadePartidas; i++) {
                Engine engine = new Engine(quantidadeRodadasMax, nomeArquivoConfiguracao, propriedadesSorteadas);
                engine.jogar();
            ...
            System.out.println("Não foi possível iniciar o jogo.");
